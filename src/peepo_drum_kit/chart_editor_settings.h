...
namespace PeepoDrumKit
{
	...
	struct UserSettingsData
	{
		...
		struct GeneralData
		{
			...
			WithDefault<std::vector<i32>> GridBarDivisions = std::vector{ 1, 2, 4, 8, 12, 16, 24, 32, 48, 64, 96, 192 };
			WithDefault<std::vector<i32>> GridBarDivisionsRough = std::vector{ 1, 2, 4, 8, 16, 32, 64, 192 };
			WithDefault<std::vector<i32>> GridBarDivisionsPrecise = std::vector{ 1, 2, 4, 5, 6, 7, 8, 9, 10, 12, 14, 16, 18, 20, 24, 28, 32, 36, 40, 48, 64, 96, 192 };
		...
		struct AudioData
		{
			...
			WithDefault<f32> BalloonVolume = 1.0f;
		...
		struct InputData
		{
			...
			WithDefault<MultiInputBinding> Editor_IncreaseMasterVolume10 = {};
			WithDefault<MultiInputBinding> Editor_DecreaseMasterVolume10 = {};
			...
			WithDefault<MultiInputBinding> Timeline_InsertTempoChangeAtSelectedItems = {};
			WithDefault<MultiInputBinding> Timeline_InsertTimeSignatureChangeAtSelectedItems = {};
			WithDefault<MultiInputBinding> Timeline_InsertScrollChangeAtSelectedItems = {};
			WithDefault<MultiInputBinding> Timeline_InsertBarLineChangeAtSelectedItems = {};
			WithDefault<MultiInputBinding> Timeline_InsertScrollTypeAtSelectedItems = {};
			WithDefault<MultiInputBinding> Timeline_InsertJPOSScrollAtSelectedItems = {};
